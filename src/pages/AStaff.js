...
export default function AStaff() {
  ...
  <Link href="/AProductViands">
    <button className="w-full text-left p-2">Viand Products</button>
  </Link>
  <Link href="/AStaff">
    <button className="w-full text-left p-2 bg-red-700 rounded">Staff</button>
  </Link>
  ...
  <Link href="/AOrders">
    <button className="w-full text-left p-2">Orders</button>
        ...
        <button onClick={handleLogout} className="w-full text-left p-2 text-white rounded">
  Logout
</button>
        </div>
      </aside>
